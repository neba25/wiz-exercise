############################################
# GitHub Actions OIDC federation — pipelines assume this role instead of
# using long-lived IAM access keys (pipeline security control).
############################################
variable "github_org_repo" {
  description = "Your GitHub org/repo, e.g. \"myorg/wiz-exercise\""
  type        = string
}
